...
public class Plan implements PackageType{
    // Map to store the attributes
    private Map<String, String> attributes = new HashMap<>();

    // Attributes to be loaded
    private static final List<String> planAttributes = Arrays.asList("name", "description", "maxChange", "maxChange");

    @Override
    public void parseAttributes(JsonObject jsonObject) {
        Logger.log("\n================Parsing Plan Details================\n");
